...
// SetProgress provides a mock function with given fields: blockNumber, ctx
func (_m *TdhIdxTrackerDb) SetProgress(blockNumber uint64, ctx context.Context) error {
	ret := _m.Called(blockNumber, ctx)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(uint64, context.Context) error); ok {
		r0 = rf(blockNumber, ctx)
	} else {
		r0 = ret.Error(0)
	}
